...
public class FartTest2 extends AI{
	...
	float getVel;
	float maxVel;
	float abbremsRad = 10;	//orig = 10
	float bremsGeschw = 5;
	float stopRad = 0;	//orig = 0
	float stopRadWP = 5;	//orig = 10
	float stopRadWP2 = 2;
	...
	//Rastervariablen
	static int cellSize = 30; // orig = 20
